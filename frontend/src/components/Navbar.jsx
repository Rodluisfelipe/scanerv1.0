      ...
      <div className="container mx-auto px-4 py-3">
        <div className="flex justify-between items-center">
          <Link to="/" className="text-xl font-bold flex items-center space-x-2 group">
            ...
            <span className="font-bold tracking-wider">Scaner Tecnophone</span>
          </Link>
          ...
          {isAuthenticated && (
            <div className="hidden md:flex items-center space-x-6">
              ...
              <div className="flex space-x-1">
                <Link 
                  to="/dashboard" 
                  className="px-4 py-2 rounded-md hover:bg-blue-700 transition-colors flex items-center space-x-1"
                >
                ...
                <button 
                  onClick={logout} 
                  className="px-4 py-2 rounded-md bg-red-600 hover:bg-red-700 transition-colors flex items-center space-x-1"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        {isAuthenticated && isMenuOpen && (
          <div className="md:hidden mt-3 py-3 border-t border-blue-500 animate-fadeIn">
            <div className="flex flex-col space-y-2">
              <Link 
                to="/dashboard" 
                className="px-4 py-2 rounded-md hover:bg-blue-700 transition-colors flex items-center space-x-2"
              ...
              <button 
                onClick={logout}
                className="px-4 py-2 rounded-md bg-red-600 hover:bg-red-700 transition-colors flex items-center space-x-2 text-left"
              >
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1" />
                </svg>
